...
NewLogger returns a undistro friendly logr.Logger derived from
...
Note: the undistro library also support usage of other loggers as long as they conform to the github.com/go-logr/logr.Logger interface.

Following logging conventions are used in undistro library:
