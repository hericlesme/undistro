...
// +kubebuilder:webhook:path=/mutate-undistro-io-v1alpha1-cluster,mutating=true,failurePolicy=ignore,groups=undistro.io,resources=clusters,verbs=create;update,versions=v1alpha1,name=mcluster.undistro.io,sideEffects=None,admissionReviewVersions=v1beta1
