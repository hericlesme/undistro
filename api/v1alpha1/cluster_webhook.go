...
// +kubebuilder:webhook:path=/mutate-getupcloud-com-v1alpha1-cluster,mutating=true,failurePolicy=fail,groups=undistro.io,resources=clusters,verbs=create;update,versions=v1alpha1,name=mcluster.undistro.io,sideEffects=None,admissionReviewVersions=v1beta1
...
func (r *Cluster) Default() {
	...
	if r.Spec.ControlPlaneNode.Replicas == nil && r.Spec.BootstrapProvider == nil {
