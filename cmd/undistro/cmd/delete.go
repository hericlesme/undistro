...
var deleteCmd = &cobra.Command{
	...
	Example: Examples(`
		...
		# and the CRDs.
		undistro delete --infrastructure aws
		...
		undistro delete --infrastructure aws --namespace=foo
		...
		undistro delete --infrastructure aws --include-crd
		...
		# Important! As a consequence of this operation, all the corresponding resources managed by
		# Cluster API Providers are orphaned and there might be ongoing costs incurred as a result of this.
		undistro delete --infrastructure aws --include-namespace
		...
		undistro delete --all --include-crd  --include-namespace`),
	Args: cobra.NoArgs,
