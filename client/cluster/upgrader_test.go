	...
	tests := []struct {
		...
		},
		{
			...
			fields: fields{
				...
				proxy: test.NewFakeProxy().
					WithProviderInventory("cluster-api", undistrov1.CoreProviderType, "v1.0.0", "cluster-api-system", "").
					WithProviderInventory("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system1", "ns1").
					WithProviderInventory("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system2", "ns2"),
			},
			want: []UpgradePlan{
				{ // one upgrade plan with the latest releases in the v1alpha3 contract
					Contract:     "v1alpha3",
					...
					Providers: []UpgradeItem{
						...
						{
							Provider:    fakeProvider("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system1", "ns1"),
							NextVersion: "v2.0.1",
						},
						{
							Provider:    fakeProvider("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system2", "ns2"),
							NextVersion: "v2.0.1",
						},
					},
				},
		...
		},
		{
			...
			want: []UpgradePlan{
				{ // one upgrade plan with the latest releases in the v1alpha3 contract for the first management group
					...
					Providers: []UpgradeItem{
						{
							Provider:    fakeProvider("cluster-api", undistrov1.CoreProviderType, "v1.0.0", "cluster-api-system1", "ns1"),
							NextVersion: "v1.0.1",
						},
						{
							Provider:    fakeProvider("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system1", "ns1"),
				...
				{ // one upgrade plan with the latest releases in the v1alpha3 contract for the second management group
					...
					Providers: []UpgradeItem{
						{
							Provider:    fakeProvider("cluster-api", undistrov1.CoreProviderType, "v1.0.0", "cluster-api-system2", "ns2"),
							NextVersion: "v1.0.1",
						},
						{
							Provider:    fakeProvider("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system2", "ns2"),
...
func Test_providerUpgrader_createCustomPlan(t *testing.T) {
	...
	type args struct {
		coreProvider       undistrov1.Provider
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				coreProvider: fakeProvider("cluster-api", undistrov1.CoreProviderType, "", "cluster-api-system", ""),
				providersToUpgrade: []UpgradeItem{
					{
						Provider:    fakeProvider("infra", undistrov1.InfrastructureProviderType, "v2.0.0", "infra-system", ""),
