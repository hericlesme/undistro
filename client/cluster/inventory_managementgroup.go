...
func (mg *ManagementGroup) GetProviderByInstanceName(instanceName string) *undistrov1.Provider {
...
func deriveManagementGroups(providerList *undistrov1.ProviderList) (ManagementGroupList, error) {
...
func checkOverlappingCoreProviders(providerList *undistrov1.ProviderList) error {
...
//    e.g. cluster-api in capi-system1 watching all capi-system1, cluster-api in capi-system2 watching all capi-system2,  aws in capa-system watching all namespaces (aws is working with both CAPI instances, but this is not a configuration supported by undistro)
func checkOverlappingProviders(providerList *undistrov1.ProviderList) error {
