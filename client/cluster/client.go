...
// InjectProxy allows to override the default proxy used by undistro.
...
// InjectPollImmediateWaiter allows to override the default PollImmediateWaiter used by undistro.
...
// newWriteBackoff creates a new API Machinery backoff parameter set suitable for use with undistro write operations.
...
// newConnectBackoff creates a new API Machinery backoff parameter set suitable for use when undistro connect to a cluster.
...
// newReadBackoff creates a new API Machinery backoff parameter set suitable for use with undistro read operations.
