...
func Test_undistroClient_GetProviderComponents(t *testing.T) {
...
func Test_undistroClient_templateOptionsToVariables(t *testing.T) {
	type args struct {
...
func Test_undistroClient_templateOptionsToVariables_withExistingMachineCountVariables(t *testing.T) {
...
func Test_undistroClient_GetClusterTemplate(t *testing.T) {
	g := NewWithT(t)
...
func Test_undistroClient_ProcessYAML(t *testing.T) {
	g := NewWithT(t)
