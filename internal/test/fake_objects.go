...
func (f *FakeCluster) Objs() []client.Object {
	...
	if f.controlPlane != nil {
		...
		objs = append(objs, f.controlPlane.Objs(cluster, undistroCl)...)
	} else {
	...
	for _, machinePool := range f.machinePools {
		objs = append(objs, machinePool.Objs(cluster, undistroCl)...)
	}

	// Adds the objects for the machineDeployments
	for _, machineDeployment := range f.machineDeployments {
		objs = append(objs, machineDeployment.Objs(cluster, undistroCl)...)
	}
...
func (f *FakeControlPlane) Objs(cluster *clusterv1.Cluster, cl *undistrov1.Cluster) []client.Object {
...
func (f *FakeMachinePool) Objs(cluster *clusterv1.Cluster, cl *undistrov1.Cluster) []client.Object {
...
func (f *FakeMachineDeployment) Objs(cluster *clusterv1.Cluster, cl *undistrov1.Cluster) []client.Object {
...
func FakeCRDList() []*apiextensionslv1.CustomResourceDefinition {
	...
	externalCRD.Labels[undistrov1.ClusterctlMoveLabelName] = ""
	externalCRD.Labels[undistrov1.UndistroMoveLabelName] = ""
