...
func (f *FakeRepository) WithMetadata(version string, metadata *undistrov1.Metadata) *FakeRepository {
	scheme := runtime.NewScheme()
	if err := undistrov1.AddToScheme(scheme); err != nil {
		panic(err)
	}
	...
	metadata.SetGroupVersionKind(undistrov1.GroupVersion.WithKind("Metadata"))
